...
/// This class is responsible for performing any Cryptographic tasks such as encryption, decryption, generating random keys and generating randomg Initialization Vector.
class Cryptography {
    ...
    ///   - iv: The  Initialization Vector. The IV ensures that even if the same plaintext is encrypted multiple times with the same key, the resulting ciphertext will be different
